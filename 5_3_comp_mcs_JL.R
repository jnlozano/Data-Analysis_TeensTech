...
#JL: if sex-specific. set parameter for this. 0 = girl, 1 = boy, default = combined
if(sex == 0 ){
...
#######################################################
# X Variables 
#JL: originalx = 0 if not the original x variables and 1 if it is original
#######################################################
if(originalx == 1){
...
#JL: change between limited and normal controls. Limited = 1, normal = 0. 
#######################################################
if(limitedcont == 0){
  controls <-
    c(
