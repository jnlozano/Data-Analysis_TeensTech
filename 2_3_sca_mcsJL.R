...
if (Items== 0 & Scales==1) { # Original Set of Y scales
  ...
  y9 <- c("fconduct", "fhyper") # JL: Not sure to add selfharm to this list since it's a small list 
...
rm(results_mcs_sca_pr, y_variables_sample_pr, y_variables_sample_cm,data_short)  
