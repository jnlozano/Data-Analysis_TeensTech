...
write.table(table2, "mcs.table_no14,15.csv", sep = ",", col.names = !file.exists("table2.csv"), append = T)
#write.csv(table2,file=paste("mcs.table_no14,15.csv",sep="")) #only uncomment if you need to initialize 
